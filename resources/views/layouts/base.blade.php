        ...
        <header id="header" class="header-v3">
            <nav class="flat-mega-menu">
                ...
                <ul class="collapse">
                    ...
                    <li> <a href="{{route('home.service_categories')}}">Sevice Categories</a></li>
                    ...
                    @if(Route::has('login'))
                     @auth
                       @if(Auth::user()->utype==='ADM')
                           <li class="login-form"> <a href="#" title="Register">My Account (Admin)</a>
                            <ul class="drop-down one-column hover-fade">
                                ...
                                <li>
                                    <a href="{{route('admin.service_categories')}}">Services Categories</a>
                                </li>
                                <li>
                                    <a href="{{route('admin.all_services')}}">All Services</a>
                                </li>
                                <li>
                                    <a href="{{route('admin.slider')}}">Manage Sliders</a>
                                </li>
                                <li>
                       ...
                       @elseif(Auth::user()->utype==='SVP')
                            ...
                            <ul class="drop-down one-column hover-fade">
                                <li><a href="{{route('sprovider.dashboard')}}">dashboard</a>
                                </li>
                                <li><a href="{{route('sprovider.profile')}}">Profile</a>
                                </li>
                                <li>
                                    <a href="{{route('logout')}}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">Logout
                                    </a>
