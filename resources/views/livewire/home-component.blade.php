<div>
            ...
            <div class="tp-banner">
                <ul>
                    ...
                    <li style="display: inline;" data-transition="slidevertical" data-slotamount="1" data-masterspeed="1000"
                        data-saveperformance="off" data-title="Slide">
                        <img style="width: 100%" src="{{ asset('images/slider')}}/{{$slide->image}}" alt="{{$slide->title}}" data-bgposition="center center"
            ...
            <div class="filter-title">
                ...
                <div class="filter-header">
                    <form id="sform" action="{{route('searchService')}}" method="post">
                        @csrf 
                        <input style="width:70%;" type="text" id="q" name="q" required="required" placeholder="What Services do you want?"
                    ...
                    <div>
                        <a class="g-list" href="{{route('home.service_details',['service_slug'=>$aservice->slug])}}">
                            ...
                            <div class="info-gallery">
                                ...
                                <div class="price"><span>&#36;</span><b>From</b>{{$aservice->price}}
                                </div>
                            </div>
                        </a>
                    </div>
