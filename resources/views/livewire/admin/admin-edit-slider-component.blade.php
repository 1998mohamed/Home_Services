                              ...
                              <div class="panel panel-default">
                                <div class="panel-heading">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <a href="{{route('admin.slider')}}" class="btn btn-info pull-right">
                                                All Slides
                                            </a>
                                        </div>
                                    </div>
                                ...
                                <div class="panel-body">
                                    ...
                                    <form class="form-horizontal" wire:submit.prevent="updateSlide">
                                        ...
                                        <div class="form-group">
                                            <label for="title" class="control-label col-sm-3">Title:
                                            </label>
                                            <div class="col-sm-9">
                                        ...
                                        <div class="form-group">
                                            <label for="newimage" class="control-label col-sm-3">Image:
                                            </label>
                                            <div class="col-sm-9">
