                              ...
                              <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    ...
                                    <form class="form-horizontal" wire:submit.prevent="updateService">
                                        ...
                                        <div class="form-group">
                                            <label for="featurd" class="control-label col-sm-3">
                                            Featurd:
                                            </label>
                                            <div class="col-sm-9">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="file" class="form-control-file" name="image" wire:model="newthumbnail" />
                                                @error('newthumbnail')
                                                <p class="text-danger">
                                                    {{$message}}
                                                </p>
                                        ...
                                        <button type="submit" class="btn btn-success pull-right">Update Services</button>
                                    </form>
                                </div>
                              </div>
                            </div>
